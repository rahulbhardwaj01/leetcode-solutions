 //////////////can also do this
// for (auto p : nodes) { // Iterate over vertical columns
//     vector<int> col;  // Create a column for the current vertical
//     for (auto q : p.second) { // Iterate over levels in the current vertical
//         for (auto val : q.second) { // Iterate over node values in the multiset
//             col.push_back(val); // Add node values directly to the column
//         }
//     }
//     ans.push_back(col); // Add the entire column to the result
// }
///////////////////////////////////////////////
